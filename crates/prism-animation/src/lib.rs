...
impl Animation {
    ...
    pub fn replace_config(&mut self, config: prism_config::Animation) {
        ...
        match config.kind {
            prism_config::animations::Kind::Spring(p) => {
            ...
            prism_config::animations::Kind::Easing(p) => {
                *self = Self::ease(
                    self.clock.clone(),
                    self.from,
                    self.to,
...
impl From<prism_config::animations::Curve> for Curve {
    fn from(value: prism_config::animations::Curve) -> Self {
        match value {
            prism_config::animations::Curve::Linear => Curve::Linear,
            prism_config::animations::Curve::EaseOutQuad => Curve::EaseOutQuad,
            prism_config::animations::Curve::EaseOutCubic => Curve::EaseOutCubic,
            prism_config::animations::Curve::EaseOutExpo => Curve::EaseOutExpo,
            prism_config::animations::Curve::CubicBezier(x1, y1, x2, y2) => {
