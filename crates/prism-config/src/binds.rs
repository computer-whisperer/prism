...
impl From<prism_ipc::Action> for Action {
    fn from(value: prism_ipc::Action) -> Self {
        match value {
            prism_ipc::Action::Quit { skip_confirmation } => Self::Quit(skip_confirmation),
            prism_ipc::Action::PowerOffMonitors {} => Self::PowerOffMonitors,
            ...
            prism_ipc::Action::ScreenshotScreen {
                write_to_disk,
                show_pointer,
                path,
            } => Self::ScreenshotScreen(write_to_disk, show_pointer, path),
            prism_ipc::Action::ScreenshotWindow {
                id: None,
                write_to_disk,
                show_pointer,
                path,
            ...
            prism_ipc::Action::ToggleKeyboardShortcutsInhibit {} => {
                Self::ToggleKeyboardShortcutsInhibit
            }
            prism_ipc::Action::CloseWindow { id: None } => Self::CloseWindow,
            prism_ipc::Action::CloseWindow { id: Some(id) } => Self::CloseWindowById(id),
            prism_ipc::Action::FullscreenWindow { id: None } => Self::FullscreenWindow,
            prism_ipc::Action::FullscreenWindow { id: Some(id) } => Self::FullscreenWindowById(id),
            prism_ipc::Action::ToggleWindowedFullscreen { id: None } => {
                Self::ToggleWindowedFullscreen
            }
            prism_ipc::Action::ToggleWindowedFullscreen { id: Some(id) } => {
                Self::ToggleWindowedFullscreenById(id)
            }
            prism_ipc::Action::FocusWindow { id } => Self::FocusWindow(id),
            prism_ipc::Action::FocusWindowInColumn { index } => Self::FocusWindowInColumn(index),
            prism_ipc::Action::FocusWindowPrevious {} => Self::FocusWindowPrevious,
            prism_ipc::Action::FocusColumnLeft {} => Self::FocusColumnLeft,
            prism_ipc::Action::FocusColumnRight {} => Self::FocusColumnRight,
            prism_ipc::Action::FocusColumnFirst {} => Self::FocusColumnFirst,
            prism_ipc::Action::FocusColumnLast {} => Self::FocusColumnLast,
            prism_ipc::Action::FocusColumnRightOrFirst {} => Self::FocusColumnRightOrFirst,
            prism_ipc::Action::FocusColumnLeftOrLast {} => Self::FocusColumnLeftOrLast,
            prism_ipc::Action::FocusColumn { index } => Self::FocusColumn(index),
            prism_ipc::Action::FocusWindowOrMonitorUp {} => Self::FocusWindowOrMonitorUp,
            prism_ipc::Action::FocusWindowOrMonitorDown {} => Self::FocusWindowOrMonitorDown,
            prism_ipc::Action::FocusColumnOrMonitorLeft {} => Self::FocusColumnOrMonitorLeft,
            prism_ipc::Action::FocusColumnOrMonitorRight {} => Self::FocusColumnOrMonitorRight,
            ...
            prism_ipc::Action::FocusWindowOrWorkspaceUp {} => Self::FocusWindowOrWorkspaceUp,
            prism_ipc::Action::FocusWindowTop {} => Self::FocusWindowTop,
            prism_ipc::Action::FocusWindowBottom {} => Self::FocusWindowBottom,
            prism_ipc::Action::FocusWindowDownOrTop {} => Self::FocusWindowDownOrTop,
            prism_ipc::Action::FocusWindowUpOrBottom {} => Self::FocusWindowUpOrBottom,
            prism_ipc::Action::MoveColumnLeft {} => Self::MoveColumnLeft,
            prism_ipc::Action::MoveColumnRight {} => Self::MoveColumnRight,
            prism_ipc::Action::MoveColumnToFirst {} => Self::MoveColumnToFirst,
            prism_ipc::Action::MoveColumnToLast {} => Self::MoveColumnToLast,
            prism_ipc::Action::MoveColumnToIndex { index } => Self::MoveColumnToIndex(index),
            prism_ipc::Action::MoveColumnLeftOrToMonitorLeft {} => {
                Self::MoveColumnLeftOrToMonitorLeft
            }
            prism_ipc::Action::MoveColumnRightOrToMonitorRight {} => {
                Self::MoveColumnRightOrToMonitorRight
            }
            prism_ipc::Action::MoveWindowDown {} => Self::MoveWindowDown,
            prism_ipc::Action::MoveWindowUp {} => Self::MoveWindowUp,
            prism_ipc::Action::MoveWindowDownOrToWorkspaceDown {} => {
                Self::MoveWindowDownOrToWorkspaceDown
            }
            prism_ipc::Action::MoveWindowUpOrToWorkspaceUp {} => Self::MoveWindowUpOrToWorkspaceUp,
            prism_ipc::Action::ConsumeOrExpelWindowLeft { id: None } => {
                Self::ConsumeOrExpelWindowLeft
            }
            prism_ipc::Action::ConsumeOrExpelWindowLeft { id: Some(id) } => {
                Self::ConsumeOrExpelWindowLeftById(id)
            }
            prism_ipc::Action::ConsumeOrExpelWindowRight { id: None } => {
                Self::ConsumeOrExpelWindowRight
            }
            prism_ipc::Action::ConsumeOrExpelWindowRight { id: Some(id) } => {
                Self::ConsumeOrExpelWindowRightById(id)
            }
            prism_ipc::Action::ConsumeWindowIntoColumn {} => Self::ConsumeWindowIntoColumn,
            prism_ipc::Action::ExpelWindowFromColumn {} => Self::ExpelWindowFromColumn,
            prism_ipc::Action::SwapWindowRight {} => Self::SwapWindowRight,
            prism_ipc::Action::SwapWindowLeft {} => Self::SwapWindowLeft,
            prism_ipc::Action::ToggleColumnTabbedDisplay {} => Self::ToggleColumnTabbedDisplay,
            prism_ipc::Action::SetColumnDisplay { display } => Self::SetColumnDisplay(display),
            prism_ipc::Action::CenterColumn {} => Self::CenterColumn,
            prism_ipc::Action::CenterWindow { id: None } => Self::CenterWindow,
            prism_ipc::Action::CenterWindow { id: Some(id) } => Self::CenterWindowById(id),
            prism_ipc::Action::CenterVisibleColumns {} => Self::CenterVisibleColumns,
            prism_ipc::Action::FocusWorkspaceDown {} => Self::FocusWorkspaceDown,
            prism_ipc::Action::FocusWorkspaceUp {} => Self::FocusWorkspaceUp,
            prism_ipc::Action::FocusWorkspace { reference } => {
                Self::FocusWorkspace(WorkspaceReference::from(reference))
            }
            prism_ipc::Action::FocusWorkspacePrevious {} => Self::FocusWorkspacePrevious,
            prism_ipc::Action::MoveWindowToWorkspaceDown { focus } => {
                Self::MoveWindowToWorkspaceDown(focus)
            }
            prism_ipc::Action::MoveWindowToWorkspaceUp { focus } => {
                Self::MoveWindowToWorkspaceUp(focus)
            }
            prism_ipc::Action::MoveWindowToWorkspace {
                window_id: None,
                reference,
                focus,
            ...
            prism_ipc::Action::MoveColumnToWorkspaceDown { focus } => {
                Self::MoveColumnToWorkspaceDown(focus)
            }
            prism_ipc::Action::MoveColumnToWorkspaceUp { focus } => {
                Self::MoveColumnToWorkspaceUp(focus)
            }
            prism_ipc::Action::MoveColumnToWorkspace { reference, focus } => {
                Self::MoveColumnToWorkspace(WorkspaceReference::from(reference), focus)
            }
            prism_ipc::Action::MoveWorkspaceDown {} => Self::MoveWorkspaceDown,
            prism_ipc::Action::MoveWorkspaceUp {} => Self::MoveWorkspaceUp,
            prism_ipc::Action::SetWorkspaceName {
                name,
                workspace: None,
            ...
            prism_ipc::Action::UnsetWorkspaceName { reference: None } => Self::UnsetWorkspaceName,
            prism_ipc::Action::UnsetWorkspaceName {
                reference: Some(reference),
            } => Self::UnsetWorkSpaceNameByRef(WorkspaceReference::from(reference)),
            prism_ipc::Action::FocusMonitorLeft {} => Self::FocusMonitorLeft,
            prism_ipc::Action::FocusMonitorRight {} => Self::FocusMonitorRight,
            prism_ipc::Action::FocusMonitorDown {} => Self::FocusMonitorDown,
            prism_ipc::Action::FocusMonitorUp {} => Self::FocusMonitorUp,
            prism_ipc::Action::FocusMonitorPrevious {} => Self::FocusMonitorPrevious,
            prism_ipc::Action::FocusMonitorNext {} => Self::FocusMonitorNext,
            prism_ipc::Action::FocusMonitor { output } => Self::FocusMonitor(output),
            prism_ipc::Action::MoveWindowToMonitorLeft {} => Self::MoveWindowToMonitorLeft,
            prism_ipc::Action::MoveWindowToMonitorRight {} => Self::MoveWindowToMonitorRight,
            prism_ipc::Action::MoveWindowToMonitorDown {} => Self::MoveWindowToMonitorDown,
            prism_ipc::Action::MoveWindowToMonitorUp {} => Self::MoveWindowToMonitorUp,
            prism_ipc::Action::MoveWindowToMonitorPrevious {} => Self::MoveWindowToMonitorPrevious,
            prism_ipc::Action::MoveWindowToMonitorNext {} => Self::MoveWindowToMonitorNext,
            prism_ipc::Action::MoveWindowToMonitor { id: None, output } => {
                Self::MoveWindowToMonitor(output)
            }
            prism_ipc::Action::MoveWindowToMonitor {
                id: Some(id),
                output,
            } => Self::MoveWindowToMonitorById { id, output },
            prism_ipc::Action::MoveColumnToMonitorLeft {} => Self::MoveColumnToMonitorLeft,
            prism_ipc::Action::MoveColumnToMonitorRight {} => Self::MoveColumnToMonitorRight,
            prism_ipc::Action::MoveColumnToMonitorDown {} => Self::MoveColumnToMonitorDown,
            prism_ipc::Action::MoveColumnToMonitorUp {} => Self::MoveColumnToMonitorUp,
            prism_ipc::Action::MoveColumnToMonitorPrevious {} => Self::MoveColumnToMonitorPrevious,
            prism_ipc::Action::MoveColumnToMonitorNext {} => Self::MoveColumnToMonitorNext,
            prism_ipc::Action::MoveColumnToMonitor { output } => Self::MoveColumnToMonitor(output),
            prism_ipc::Action::SetWindowWidth { id: None, change } => Self::SetWindowWidth(change),
            prism_ipc::Action::SetWindowWidth {
                id: Some(id),
                change,
            ...
            prism_ipc::Action::SwitchPresetWindowWidth { id: Some(id) } => {
                Self::SwitchPresetWindowWidthById(id)
            }
            prism_ipc::Action::SwitchPresetWindowWidthBack { id: Some(id) } => {
                Self::SwitchPresetWindowWidthBackById(id)
            }
            prism_ipc::Action::SwitchPresetWindowHeight { id: None } => {
                Self::SwitchPresetWindowHeight
            }
            prism_ipc::Action::SwitchPresetWindowHeightBack { id: None } => {
                Self::SwitchPresetWindowHeightBack
            }
            prism_ipc::Action::SwitchPresetWindowHeight { id: Some(id) } => {
                Self::SwitchPresetWindowHeightById(id)
            }
            prism_ipc::Action::SwitchPresetWindowHeightBack { id: Some(id) } => {
                Self::SwitchPresetWindowHeightBackById(id)
            }
            prism_ipc::Action::MaximizeColumn {} => Self::MaximizeColumn,
            prism_ipc::Action::MaximizeWindowToEdges { id: None } => Self::MaximizeWindowToEdges,
            prism_ipc::Action::MaximizeWindowToEdges { id: Some(id) } => {
            ...
            prism_ipc::Action::MoveWorkspaceToMonitorRight {} => Self::MoveWorkspaceToMonitorRight,
            prism_ipc::Action::MoveWorkspaceToMonitorDown {} => Self::MoveWorkspaceToMonitorDown,
            prism_ipc::Action::MoveWorkspaceToMonitorUp {} => Self::MoveWorkspaceToMonitorUp,
            prism_ipc::Action::MoveWorkspaceToMonitorPrevious {} => {
                Self::MoveWorkspaceToMonitorPrevious
            }
            prism_ipc::Action::MoveWorkspaceToIndex {
                index,
                reference: Some(reference),
            ...
            prism_ipc::Action::MoveWorkspaceToMonitor {
                output,
                reference: Some(reference),
            ...
            prism_ipc::Action::MoveWorkspaceToMonitorNext {} => Self::MoveWorkspaceToMonitorNext,
            prism_ipc::Action::ToggleDebugTint {} => Self::ToggleDebugTint,
            prism_ipc::Action::DebugToggleOpaqueRegions {} => Self::DebugToggleOpaqueRegions,
            prism_ipc::Action::DebugToggleDamage {} => Self::DebugToggleDamage,
            prism_ipc::Action::ToggleWindowFloating { id: None } => Self::ToggleWindowFloating,
            prism_ipc::Action::ToggleWindowFloating { id: Some(id) } => {
                Self::ToggleWindowFloatingById(id)
            }
            prism_ipc::Action::MoveWindowToFloating { id: None } => Self::MoveWindowToFloating,
            prism_ipc::Action::MoveWindowToFloating { id: Some(id) } => {
                Self::MoveWindowToFloatingById(id)
            }
            prism_ipc::Action::MoveWindowToTiling { id: None } => Self::MoveWindowToTiling,
            prism_ipc::Action::MoveWindowToTiling { id: Some(id) } => {
                Self::MoveWindowToTilingById(id)
            }
            prism_ipc::Action::FocusFloating {} => Self::FocusFloating,
            prism_ipc::Action::FocusTiling {} => Self::FocusTiling,
            prism_ipc::Action::SwitchFocusBetweenFloatingAndTiling {} => {
            ...
            prism_ipc::Action::SetDynamicCastWindow { id: None } => Self::SetDynamicCastWindow,
            prism_ipc::Action::SetDynamicCastWindow { id: Some(id) } => {
                Self::SetDynamicCastWindowById(id)
            }
            prism_ipc::Action::SetDynamicCastMonitor { output } => {
                Self::SetDynamicCastMonitor(output)
            }
            prism_ipc::Action::ClearDynamicCastTarget {} => Self::ClearDynamicCastTarget,
            prism_ipc::Action::StopCast { session_id } => Self::StopCast(session_id),
            prism_ipc::Action::ToggleOverview {} => Self::ToggleOverview,
            prism_ipc::Action::OpenOverview {} => Self::OpenOverview,
            prism_ipc::Action::CloseOverview {} => Self::CloseOverview,
            prism_ipc::Action::ToggleWindowUrgent { id } => Self::ToggleWindowUrgent(id),
            prism_ipc::Action::SetWindowUrgent { id } => Self::SetWindowUrgent(id),
            prism_ipc::Action::UnsetWindowUrgent { id } => Self::UnsetWindowUrgent(id),
            prism_ipc::Action::LoadConfigFile { path } => Self::LoadConfigFile(path),
        }
    }
}
